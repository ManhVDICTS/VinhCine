...
abstract class AuthService {
  ...
  Future<ObjectResponse<dynamic>> signOut(
...
ObjectResponse<dto.ProfileDTO> deserializeObjectResponse<PayloadDTO>(
...
Map<String, dynamic> serializeObjectResponse(ObjectResponse object) =>
    object.toJson((obj) => obj.toJson());
