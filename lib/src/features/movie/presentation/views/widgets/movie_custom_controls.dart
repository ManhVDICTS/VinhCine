...
class CustomMovieControls extends StatefulWidget {
  const CustomMovieControls({
  ...
  State<StatefulWidget> createState() {
    return _CustomMovieControlsState();
  }
}

class _CustomMovieControlsState extends State<CustomMovieControls>
        ...
        child: AbsorbPointer(
          ...
          child: Stack(
            children: [
              ...
              if (_chewieController?.isFullScreen == false && !notifier.hideStuff)
                Container(
